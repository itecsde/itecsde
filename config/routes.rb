AREAV03::Application.routes.draw do
  ...
  scope "(/:locale)", :locale => /en|es|pt|lt|no|tr|fr|nl|gl|sk|hu|fi|it/ do
    ...
    match "/search_results/all_best_search_results" => "search_results#all_best_search_results" , :as => "all_best_search_results"
    match "/search_results/load_more_search_results" => "search_results#load_more_search_results" , :as => "load_more_search_results"
    match "/search_results/load_more_related_elements" => "search_results#load_more_related_elements" , :as => "load_more_related_elements"
    ...
    match "/documents/popup_show_documents" => "documents#popup_show_document", :as => "popup_show_document"
    resources :documents   
    match "/participants/popup_show_participants" => "forms#popup_show_participant", :as => "popup_show_participant"
    resources :participants   
    match "/reports/popup_show_reports" => "reports#popup_show_report", :as => "popup_show_report"
    match "/reports/load_more_reports_by_section_and_date" => "reports#load_more_reports_by_section_and_date" , :as => "load_more_reports_by_section_and_date"
    match "/reports/index_all" => "reports#index_all", :as => "index_all_reports"
    resources :reports
    match "/widgets/popup_show_reports" => "widgets#popup_show_widget", :as => "popup_show_widget"
    resources :widgets
    match "/klascements/popup_show_klascements" => "klascements#popup_show_klascement", :as => "popup_show_klascement"
    resources :klascements
    match "/artworks/popup_show_artworks" => "artworks#popup_show_artwork", :as => "popup_show_artwork"
    resources :artworks
    match "/reuters_new_items/popup_show_reuters_new_items" => "reuters_new_items#popup_show_reuters_new_item", :as => "popup_show_reuters_new_item"
    resources :reuters_new_items    
    match "/books/popup_show_books" => "books#popup_show_book", :as => "popup_show_book"
    resources :books    
    ...
    match 'about/faqs' => 'about#faqs', as: :about_faqs
    match 'about/about_us' => 'about#about_us', as: :about_about_us
    match 'about/contact' => 'about#contact', as: :about_contact    
