class ArtworksController < ApplicationController
  ...
  def index
    ...
    if (params[:advanced_search]=="1") 
      ...
      @search = Search.advanced_search_elements_by_type('Artwork', search_text,search_text_en_translation, advanced_parameters,per_page,params[:page])
      ...
      @search = Search.listing_elements_by_type('Artwork', search_languages, current_user, per_page,params[:page])
      @artworks = @search[:results]          
      @num_results = @search[:total] 
=begin        
