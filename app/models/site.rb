class Site < ActiveRecord::Base
  ...
  attr_accessible :element_image, :name, :description, :url, :link, :address, :latitude, :longitude, :owner_type, :owner_id, :scraped_from, :creator_id, :tag_list, :taggable_tags_annotations
  ...
  def persist(idiomas_disponibles, prosa, manual_tags)
    ...
    scraped_site.extract_wikitopics(self.name, prosa, manual_tags)
