                  ...
                  if @state == "running"
                     ...
                     when "concept_language_correspondence"
                        ...
                        if resource.taggable_tag_annotations.where(:type_tag=>"automatic").size > 0
                           resource.document_language_concept_correspondence(resource, "es","en")
                           #Document
                     ...
                     when "annotate_esa"
                        resource.extract_esa_topics(resource.name, resource.description)
                        puts "Resource ESA annotated"                            
                     when "expand_concepts"
                        ...
                        resource.extract_wikitopics_only_from_title_and_description(resource.name, resource.description, @wikipediator_ip)
