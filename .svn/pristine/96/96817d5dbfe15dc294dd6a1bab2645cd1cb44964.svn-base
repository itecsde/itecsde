class Application < ActiveRecord::Base
  ...
  attr_accessible :element_image, :name, :description, :url, :itec_identificator, :ld_id, :external, :application_functionality_annotations_attributes, :application_operating_system_annotations, :application_operating_system_annotations_attributes, :owner_type, :owner_id, :tag_list
...
def persist(idiomas_disponibles, prosa, manual_tags, operating_systems, photo_url, icon_url)
    ...
    if check_result == "insert"
      ...
      scraped_application.extract_wikitopics(self.name, prosa, manual_tags)
