class Artwork < ActiveRecord::Base
  ...
  # A artwork may have many comments
  has_many :comments, :as => :commentable, :dependent => :destroy
  
  # A artwork is categorised into many subjects
  has_many :artwork_subject_annotations, :dependent => :destroy
  has_many :subjects, :through => :artwork_subject_annotations
  accepts_nested_attributes_for :artwork_subject_annotations, :allow_destroy => :true
  
  
  # A artwork is bookmarkable
  ...
  # And a artwork may include a representative picture
  attr_accessible :element_image, :name, :description, :url, :link, :artwork_subject_annotations_attributes, :owner_type, :owner_id, :scraped_from, :creator_id, :tag_list, :author, :museum
