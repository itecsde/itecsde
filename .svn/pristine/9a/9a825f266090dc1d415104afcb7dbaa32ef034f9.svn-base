...
scenario_template = Scenario.create(
  name: 'Create a model',
  description: 'Design technology teacher Mr P, Geography teacher Ms D, physics teacher Mrs M and Math teacher Mr W create an annual cross-curricular design challenge for students which will develop their subject related skills as well as involving them in a ‘real-world’ challenge that is related to their local area.
