class Article < ActiveRecord::Base
  ...
  # An article is categorised into many subjects
  has_many :article_subject_annotations, :dependent => :destroy
  has_many :subjects, :through => :article_subject_annotations
  accepts_nested_attributes_for :article_subject_annotations, :allow_destroy => :true
  
  # An article is bookmarkable
  ...
  # And an article may include a representative picture
  attr_accessible :element_image, :name, :description, :url, :link, :article_subject_annotations_attributes, :owner_type, :owner_id, :scraped_from, :creator_id, :tag_list
