class Klascement < ActiveRecord::Base
  include Taggable
  include Ownable
  ...
  # A klascement may have many comments
  has_many :comments, :as => :commentable, :dependent => :destroy
  
  # A klascement is categorised into many subjects
  has_many :klascement_subject_annotations, :dependent => :destroy
  has_many :subjects, :through => :klascement_subject_annotations
  accepts_nested_attributes_for :klascement_subject_annotations, :allow_destroy => :true
  
  
  # A klascement is bookmarkable
  ...
  # And a klascement may include a representative picture
  attr_accessible :element_image, :name, :description, :url, :link, :klascement_subject_annotations_attributes, :owner_type, :owner_id, :scraped_from, :creator_id, :tag_list
