...
Explore.name= "Explorar: Observación"
Explore.description= "Os equipos de estudantes exploran o contexto do seu deseño mediante a observación das prácticas ou ámbitos pertinentes utilizando cámaras dixitais, ordenadores portátiles e micrófonos. O obxecto da observación depende da quen se está a deseñar, para o que están a deseñar e os retos iniciais que queren abordar. Os estudantes comparten os seus arquivos e analízanos. Sobre a base da información recollida e a súa análise, os estudantes refinan a súa proposta de deseño, sobre todo os problemas de deseño e os resultados de deseño. A continuación, gravan unha reflexión e actualizan o seu blog."
Explore.save
...
Collaborate.name= "Colaborar"
Collaborate.description= "Os estudantes colaboran con estudantes doutras escolas iTEC. A colaboración ocasional e ao hazar promovida polos estudantes é alentada."
Collaborate.save
...
collaborative = Tag.create(name: 'colaborativo')
...
Collaborate.tags << collaborative

Make.tags << interesting
